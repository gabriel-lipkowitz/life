...
<<<<<<< HEAD
  threeGlobe
} from "./chunk-JO4OCVVM.js";
import "./chunk-7A7Q6VQA.js";
=======
  Easing,
  Group,
  Tween
...
function viewDigest(data, existingObjs, appendObj, removeObj, _ref7) {
  ...
  var _dataBindDiff = dataBindDiff(data, existingObjs, _objectSpread2({
    objBindAttr,
    dataBindAttr
  }, dataDiffOptions)), enter = _dataBindDiff.enter, update16 = _dataBindDiff.update, exit = _dataBindDiff.exit;
  ...
  var pointsData = [].concat(_toConsumableArray2(enter), _toConsumableArray2(update16));
...
var LineSegments2 = class extends THREE3.Mesh {
  ...
  raycast(raycaster, intersects2) {
    ...
    const lineWidth = material.linewidth + threshold2;
    const instanceStart = geometry.attributes.instanceStart;
    const instanceEnd = geometry.attributes.instanceEnd;
    ...
    for (let i = 0, l = instanceStart.count; i < l; i++) {
      ...
      if (isInClipSpace && isInside) {
        ...
        const point2 = new THREE3.Vector3();
        ray.distanceSqToSegment(_line.start, _line.end, point2, pointOnLine);
        intersects2.push({
          point: point2,
          pointOnLine,
          distance: ray.origin.distanceTo(point2),
          object: this,
          face: null,
          faceIndex: i,
          uv: null,
...
var PointsLayerKapsule = index({
  ...
  update: function update2(state) {
    ...
    var pointMaterials = {};
    var scene = state.pointsMerge ? new THREE$e.Object3D() : state.scene;
...
var HexBinLayerKapsule = index({
  ...
  update: function update4(state) {
    ...
    var hexMaterials = {};
    var scene = state.hexBinMerge ? new THREE$c.Object3D() : state.scene;
...
var THREE$22 = _objectSpread22(_objectSpread22({}, window.THREE ? window.THREE : {}), {}, {
  CSS2DObject
});
  ...
  update: function update12(state, changedProps) {
    ...
    threeDigest(state.htmlElementsData, state.scene, {
      ...
      createObj: function createObj(d) {
        ...
        var obj = new THREE$22.CSS2DObject(elem);
...
var ObjectsLayerKapsule = index({
  props: {
    ...
    objectRotation: {},
    objectThreeObject: {
      "default": new THREE$12.Mesh(
        // default object: yellow sphere
        new THREE$12.SphereGeometry(1, 16, 8),
        new THREE$12.MeshLambertMaterial({
          color: "#ffffaa",
          transparent: true,
          opacity: 0.7
        })
...
>>>>>>> 83a9cde90d07dfc85734b4a998cc5b1413d67d32
export {
